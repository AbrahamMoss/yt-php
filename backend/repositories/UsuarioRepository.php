<?php
    ...
    class UsuarioRepository {
        ...
        public function create(Usuario $usuario) {
            $sql = "INSERT INTO usuarios (nombre, apaterno, amaterno, direccion, telefono, 
                                        ciudad, estado, usuario, password, rol)
                    VALUES (:nombre, :apaterno, :amaterno, :direccion, :telefono, :ciudad, 
                            :estado, :usuario, :password, :rol)";
        ...
        public function update(Usuario $usuario) {
            ...
            $sql = "UPDATE usuarios SET nombre = :nombre, apaterno = :apaterno, 
                        amaterno = :amaterno, direccion = :direccion, telefono = :telefono, 
                        ciudad = :ciudad, estado = :estado, usuario = :usuario, 
